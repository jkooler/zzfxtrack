...
export function generateInstrumentsFile() {
    ...
    content += `// Auto-generated by ZzFXMicro Music\n`;
    content += `//\n`;
    ...
    content += `/**\n`;
    content += ` * Strudel Sound Names to ZzFXMicro Player Channel Indices\n`;
    content += ` * This mapping ensures we can use descriptive names in Strudel\n`;
    content += ` * while still baking to correct ZzFXMicro Player channels.\n`;
    content += ` */\n`;
