...
export function buildZzFXTrackSongJsModule(songData) {
    const headerLines = [
...
export function renderSongDataPreview() {
    ...
    if (songDataViewMode === 'js') {
        dom.previewJson.innerText = buildZzFXTrackSongJsModule(lastExportedData);
    } else {
...
export function installExportPreviewHandlers() {
    ...
    dom.previewPlayBtn.addEventListener('click', () => {
        ...
        deps.playZzFXTrackSong(lastExportedData, deps.getAudioContext(), () => {
            updatePreviewPlayButton(false);
